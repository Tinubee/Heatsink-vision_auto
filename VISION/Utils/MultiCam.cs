...
namespace Euresys
{
    ...
    namespace MultiCam
    {
        ...
        public sealed class MC
        {
            ...
            public const UInt32 SurfaceCount = (82 << 14);
            public const UInt32 GrabCount = (23 << 14);
            public const UInt32 Gain = (44 << 14);
            public const UInt32 PageLength_Ln = (1039 << 14);
            public const UInt32 Exposure = (611 << 14);
            public const UInt32 ImageSizeX = (523 << 14);
            public const UInt32 ImageSizeY = (524 << 14);

            public const UInt32 SurfaceSize = (27 << 14);
            public const UInt32 SurfaceAddr = (28 << 14);
            public const UInt32 SurfacePitch = (29 << 14);
            public const UInt32 SurfaceContext = (32 << 14);
            public const UInt32 Cluster = (12 << 14);
